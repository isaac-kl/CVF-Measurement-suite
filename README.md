Code developed to run IEC CV measurement equipment using Hioki IM3536 LCR, Kiethley 2400 SMU, Kiethley 2100 Multimeter. Code can be changed to run with other equiment with small changes.
